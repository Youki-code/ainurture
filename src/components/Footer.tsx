...
export function Footer() {
  ...
  // Help & Support links - Removed API Reference, Status Page, and Security
  const helpLinks = [
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8 pb-12 border-b border-[#00F0FF]/10">
          ...
          <div className="max-w-sm">
            ...
            <p className="text-gray-400 mb-6">
              Transform your lead nurturing process with next-generation AI technology. 
              Automated, adaptive, and always learning.
            </p>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-wrap justify-center md:justify-end gap-6">
            <a href="#privacy" className="text-sm text-gray-400 hover:text-[#00F0FF] transition-colors">
              Privacy Policy
            </a>
            <a href="#terms" className="text-sm text-gray-400 hover:text-[#00F0FF] transition-colors">
              Terms of Service
            </a>
            <a href="#cookies" className="text-sm text-gray-400 hover:text-[#00F0FF] transition-colors">
              Cookie Policy
            </a>
          </div>
        </div>
