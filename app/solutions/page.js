  ...
  const solutions = [
    {
      ...
      title: "Enterprise",
      description:
        "Comprehensive lead management solution for large organizations",
      features: [
        "Custom AI models",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Choose the perfect plan that matches your business needs and
              growth ambitions.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {solutions.map((solution, index) => (
              <FloatingElement key={index} className="h-full">
