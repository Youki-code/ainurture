...
export default function Pricing() {
  ...
  const features = [
    {
      ...
      individual: true,
      business: true,
      description: "Automated lead qualification and ranking",
    },
    {
    ...
    {
      name: "Self-Evolving Email/Text Campaigns",
      individual: true,
      business: true,
      description: "AI-powered campaigns that learn and adapt automatically",
    },
    {
      name: "Cloud Storage",
      individual: true,
      business: true,
      description: "10GB for Individual, Unlimited for Business",
    },
    {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Yes, you can upgrade or downgrade your plan at any time. The billing will be prorated accordingly.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Individual plan users will be notified when approaching the limit. Business plans include unlimited storage.",
    },
    {
  ...
  const companyLogos = [
    {
      name: "TechCorp",
      url: "https://images.unsplash.com/photo-1516876437184-593fda40c7ce?auto=format&fit=crop&w=150&h=150",
    },
    {
      name: "InnovateAI",
      url: "https://images.unsplash.com/photo-1516876437184-593fda40c7ce?auto=format&fit=crop&w=150&h=150",
          ...
          <FloatingElement className="h-full">
            <div className="h-full p-8 rounded-2xl bg-gradient-to-br from-[#00F0FF]/5 to-[#A742FF]/5 border border-[#00F0FF]/20 backdrop-blur-sm relative overflow-hidden">
              ...
              <div className="mb-8">
                ...
                {isAnnual && (
                  <p className="text-[#00F0FF] text-sm mt-2">
          ...
          <FloatingElement className="h-full">
            <div className="h-full p-8 rounded-2xl bg-gradient-to-br from-[#00F0FF]/5 to-[#A742FF]/5 border border-[#00F0FF]/20 backdrop-blur-sm relative overflow-hidden">
              ...
              <div className="mb-8">
                ...
                <span className="text-gray-400">/month</span>
                {isAnnual && (
                  <p className="text-[#A742FF] text-sm mt-2">
